...
import { Star, Heart, BarChart2, Eye, ShoppingCart, Zap, Shield, Award, Truck, Clock } from 'lucide-react';
...
interface MircliProductCardProps {
  product: MircliProduct;
  viewMode?: 'grid' | 'list';
  showQuickView?: boolean;
  onQuickView?: (product: MircliProduct) => void;
  onAddToCart?: (product: MircliProduct) => void;
}

const MircliProductCard: React.FC<MircliProductCardProps> = ({
  product,
  viewMode = 'grid',
  showQuickView = true,
  onQuickView,
          ...
          <div>
            ...
            <div className="flex items-start justify-between mb-3">
              <div>
                ...
                <Link 
                  to={`/ventilation/${product.category}/${product.id}`}
...
export default MircliProductCard; 