...
function getCategorySlug(category: string): string {
  const slugs: { [key: string]: string } = {
    ...
    "Промышленные вентиляторы": "promyshlennye-ventilyatory",
    ...
    "600x300 мм": "600x300-mm",
    "800x400 мм": "800x400-mm",
    "1000x500 мм": "1000x500-mm",
    
    // Подкатегории крышных
    "125 мм крышные": "125-mm",
    "160 мм крышные": "160-mm",
    "200 мм крышные": "200-mm",
    "250 мм крышные": "250-mm",
    "315 мм крышные": "315-mm",
    "400 мм крышные": "400-mm",
    "500 мм крышные": "500-mm",
    "630 мм крышные": "630-mm",
    "710 мм крышные": "710-mm",
    "≥ 860 мм": "-860-mm",
    
    // Подкатегории осевых
    "≤ 150 мм": "-150mm",
    "250 мм осевые": "250-mm",
    "315 мм осевые": "315-mm",
    "400 мм осевые": "400-mm",
    "500 мм осевые": "500-mm",
    "630 мм осевые": "630-mm",
    "710 мм осевые": "710-mm",
    
    // Подкатегории вентиляционных установок
    "Приточные установки": "pritochnye-ventilyacionnye-ustanovki",
    "Приточно-вытяжные": "pritochno-vytyazhnye-ventilyacionnye-unstanovki",
    "Бытовые установки": "bytovye-ustanovki",
    "Вытяжные установки": "vytyazhnye-ustanovki",
    "Аксессуары": "aksessuary-dlya-ventilyacionnykh-ustanovok",
    
    // Подкатегории приточных и приточно-вытяжных установок
    "500 м³/ч": "500-m-ch",
    "750 м³/ч": "750-m-ch",
    "1000 м³/ч": "1000-m-ch",
    "1500 м³/ч": "1500-m-ch",
    ...
    "6000 м³/ч": "6000-m-ch",
    "8000 м³/ч": "8000-m-ch",
    "10000 м³/ч": "10000-m-ch",
    
    // Подкатегории бытовых установок
    "Бытовые приточные": "bytovye-pritochnye",
    "Бытовые приточно-вытяжные": "bytovye-pritochno-vytyazhnye",
    "Проветриватели": "provetrivateli",
    
    // Подкатегории сетевых элементов
    "Нагреватели": "nagrevateli",
    "Охладители": "ohladiteli",
    "Фильтр-боксы": "filtr-boksy",
    "Блоки обеззараживания": "bloki-obezzarazhivaniya",
    "Воздушные клапаны": "vozdushnye-klapany",
    "Шумоглушители": "shumoglushiteli",
    "Рекуператоры": "rekuperatory",
    
    // Подкатегории автоматики
    "Регуляторы скорости": "regulyatory-skorosti",
    "Смесительные узлы": "smesitelnye-uzly",
    "Щиты управления": "shity-upravleniya",
    "Контроллеры": "kontrollery",
    "Пульты управления": "pulty-upravleniya",
    "Датчики": "datchiki-dlya-ventilyacii",
    "Электроприводы": "elektroprivody",
    "Регуляторы температуры": "regulyatory-temperatury",
    
    // Подкатегории регуляторов скорости
    "Плавные": "plavnye",
    "Пятиступенчатые": "pyatistupenchatye",
    "Частотные преобразователи": "chastotnye-preobrazovateli",
    
    // Подкатегории смесительных узлов
    "для водяных калориферов": "dlya-vodyanyh-kaloriferov",
    
    // Подкатегории щитов управления
    "Для установок с водяным нагревателем": "dlya-ustanovok-s-vodyanym-nagrevatelem",
    "Для установок с электрическим нагревателем": "dlya-ustanovok-s-elektricheskim-nagrevatelem",
    
    // Подкатегории датчиков
    "Давления": "davleniya",
    "Температуры": "temperatury",
    "Термостаты": "termostaty",
    "Гигростаты": "gigrostaty",
    "Влажности": "vlazhnosti",
    "Обратной воды": "obratnoj-vody",
    "Качества воздуха и CO2": "kachestva-vozdukha-i-co2",
    
    // Подкатегории вентиляционных решеток
    "Пластиковые": "plastik",
    "Металлические": "metall",
    "Деревянные": "derevyannye",
    
    // Подкатегории воздуховодов
    "Гибкие воздуховоды": "gibkiye-vozdukhovody",
    "Полужесткие воздуховоды": "poluzhestkiye-vozdukhovody",
    "Жесткие воздуховоды": "zhestkiye-vozdukhovody",
    
    // Подкатегории гибких воздуховодов
    "Изолированные": "izolirovannyye",
    "Неизолированные": "neizolirovannyye",
    
    // Подкатегории полужестких воздуховодов
    "Алюминиевые": "alyuminiyevyye",
    "Пластиковые": "plastikovyye",
    
    // Подкатегории жестких воздуховодов
    "Круглые жесткие": "kruglyye",
    "Прямоугольные жесткие": "pryamougolnyye"
  };
